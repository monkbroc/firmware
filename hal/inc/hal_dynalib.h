...
DYNALIB_FN(hal,HAL_EEPROM_Get)
DYNALIB_FN(hal,HAL_EEPROM_Put)
DYNALIB_FN(hal,HAL_EEPROM_Clear)
DYNALIB_FN(hal,HAL_EEPROM_Has_Pending_Erase)
DYNALIB_FN(hal,HAL_EEPROM_Perform_Pending_Erase)
DYNALIB_END(hal)
